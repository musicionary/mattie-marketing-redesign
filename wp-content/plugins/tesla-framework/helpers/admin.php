...
if(!function_exists('get_google_fonts')){
  function get_google_fonts(){
    $fonts_json = include TT_FW_PL . 'static/google_fonts.php';
    return json_decode($fonts_json);
  }
}
if(!function_exists('seek_multidim_array')){
...
if(!function_exists('seek_multidim_array_all')){
...
if(!function_exists('seek_options')){
...
* @updated : 1.9.3
*/
if(!function_exists('tt_get_subscriptions')){
...
if(!function_exists('tt_get_value')){
...
if(!function_exists('tesla_locate_uri')){
  function tesla_locate_uri($template_names) {
    ...
    foreach ( (array) $template_names as $template_name ) {
      ...
      if ( file_exists(STYLESHEETPATH . '/' . $template_name)) {
        ...
        break;
      } else if ( file_exists(TT_FW_DIR . '/' . str_replace( 'tesla_framework/', '', $template_name) ) ) {
        $located = TT_FW . '/' . str_replace( 'tesla_framework/', '', $template_name);
        break;
      }
    }
