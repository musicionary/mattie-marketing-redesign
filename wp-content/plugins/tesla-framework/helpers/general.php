...
if(!function_exists('tt_get_mailchimp')){
...
if(!function_exists('tt_get_file_contents')){
...
if(!function_exists('_gcustom_styler')){
...
if(!function_exists('tt_text_css')){
...
if(!function_exists('_esocial_platforms')){
...
if(!function_exists('tt_get_forms')){
...
/**
* Moving adding shortcode to fw ( in the plugin version )
* @since 1.1.3
*/
