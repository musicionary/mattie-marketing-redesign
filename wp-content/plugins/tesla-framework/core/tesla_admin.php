...
if(!class_exists('Tesla_admin')){
  class Tesla_admin extends TeslaFrameworkPL {
   ...
   */
    ...
    function import_xml_ajax(){
      ...
      require_once TT_FW_PL . 'extensions/autoimport/autoimporter.php';
      ...
      if($step == 1 && file_exists(TT_THEME_DIR . '/theme_config/demo_widgets.wie')){
        require TT_FW_PL . 'extensions/widgetimport/widgetimport.php';
    ...
    */
    ...
    function autoupdate_init(){
      ...
      require TT_FW_PL . 'extensions/theme-updates/theme-update-checker.php';
