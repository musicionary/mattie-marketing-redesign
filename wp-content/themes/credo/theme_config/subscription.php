...
return array(
	...
	'required_msg' => __('Please insert email','credo'),	//message displayed when at least one required filed is not filled
	'invalid_email_class' => 'invalid_email',	//class added to the email input with an invalid email value at submission
	'invalid_email_msg'=>__("Invalid Email",'credo'),	//Invalid email message
	...
	'date_headline' => __('Date','credo'),
	'no_data_posted' => __('No data received','credo'),
	'error_open_create_files_msg' => __('Error writing to disk','credo'), //leave blank to get the php error msg
	'success_msg' => __('Successfully Subscribed','credo'),
	'error_writing_msg' => __("Couldn't write to file",'credo'),
