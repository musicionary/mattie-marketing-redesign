...
$font_size = !empty($atts['font_size']) ? ' font-size: '.$atts['font_size'].' !important;' : '';
...
<div
	...
	<div
		class="vc_icon_element-inner vc_icon_element-color-<?php echo esc_attr( $color ); ?><?php if ( $has_style ): echo ' vc_icon_element-have-style-inner'; endif; ?> vc_icon_element-size-<?php echo esc_attr( $size ); ?> vc_icon_element-style-<?php echo esc_attr( $background_style ); ?> vc_icon_element-background-color-<?php echo esc_attr( $background_color ); ?>"<?php echo esc_attr($style); ?>><span
			class="vc_icon_element-icon <?php echo esc_attr($iconClass); ?>" style="<?php echo( $color === 'custom' ? 'color:' . esc_attr( $custom_color ) . ' !important;' : ''); echo esc_attr($font_size); ?>"></span><?php
