...
function tt_register_required_plugins($get_plugins = false) {
	...
	$plugins = array(
		...
		array(
			...
			'source'                => get_template_directory() . '/plugins/rev_slider/revslider_'.tt_get_plugin_version('rev_slider').'.zip',
	 ...
	 */
	$config = array(
		'id'           => 'tt_credo',                 // Unique ID for hashing notices for multiple instances of TGMPA.
